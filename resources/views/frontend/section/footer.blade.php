<section class="footer-area pt-100px">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item pt-4">
                        ...
                        <li><a href="mailto:support_elearning@wbsite.com">support_elearning@website.com</a></li>
                        <li>DC Straße 5, 28597 Berlin, Germany </li>
                    </ul>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <h3 class="fs-20 font-weight-semi-bold">Courses & Trainings</h3>
                    <span class="section-divider section--divider"></span>
                    <ul class="generic-list-item">
                        <li><a href="#">Web Development</a></li>
                        <li><a href="#">AL Fundamentals</a></li>
                        <li><a href="#">Business</a></li>
                        <li><a href="#">Basic Programming for kids</a></li>
                        <li><a href="#">SAP for Beginners</a></li>
                        <li><a href="#">UX writing</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; 2025 E-Learning. All Rights Reserved. by <a
                            href="https://www.w3schools.com/">XYZ</a></p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
